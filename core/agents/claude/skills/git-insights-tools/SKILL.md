...
description: >-
  ...
  get_related_files
allowed-tools: >-
  mcp__ctx-cloud__get_author_expertise, mcp__ctx-cloud__get_codebase_hotspots,
  mcp__ctx-cloud__get_coupling_issues, mcp__ctx-cloud__get_file_experts,
  mcp__ctx-cloud__get_file_risk, mcp__ctx-cloud__get_git_insights_summary,
  mcp__ctx-cloud__get_module_boundaries, mcp__ctx-cloud__get_recent_activity,
  mcp__ctx-cloud__get_related_files
---
# Git insights Tools
