---
name: composite-skills-tools
description: >-
  Composite skills tools: blast_radius, code_migration, dependency_check,
  incident_response, investigate_service, understand_flow
allowed-tools: >-
  mcp__tabnine-ctx-cloud__blast_radius, mcp__tabnine-ctx-cloud__code_migration,
  mcp__tabnine-ctx-cloud__dependency_check,
  mcp__tabnine-ctx-cloud__incident_response,
  mcp__tabnine-ctx-cloud__investigate_service,
  mcp__tabnine-ctx-cloud__understand_flow
---
