...
allowed-tools: >-
  mcp__tabnine-ctx-cloud__get_coding_guidelines,
  mcp__tabnine-ctx-cloud__get_cve_resolution_status,
  mcp__tabnine-ctx-cloud__query_entities, mcp__tabnine-ctx-cloud__query_symbols,
  mcp__tabnine-ctx-cloud__search_knowledge,
  mcp__tabnine-ctx-cloud__search_skills
---
# _builtin Tools
