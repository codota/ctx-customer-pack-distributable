Collect debug logs, checkpoints, and state into a redacted support bundle (tar.gz). Use when something goes wrong and the user needs to send diagnostics to support.
